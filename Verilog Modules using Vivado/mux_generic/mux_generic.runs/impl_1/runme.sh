...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/mux_generic/mux_generic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_g.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_g.tcl -notrace
