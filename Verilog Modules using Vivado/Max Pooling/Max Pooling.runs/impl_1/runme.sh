...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/Max Pooling/Max Pooling.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max_pooling.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max_pooling.tcl -notrace
