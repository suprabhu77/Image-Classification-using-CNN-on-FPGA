...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/Max Pooling/Max Pooling.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log max_pooling.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source max_pooling.tcl
