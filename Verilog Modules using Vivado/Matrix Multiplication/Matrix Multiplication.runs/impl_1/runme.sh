...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/Matrix Multiplication/Matrix Multiplication.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matrix_multiplier.tcl -notrace
