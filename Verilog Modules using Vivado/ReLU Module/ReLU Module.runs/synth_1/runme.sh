...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/ReLU Module/ReLU Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReLU_Activation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReLU_Activation.tcl
