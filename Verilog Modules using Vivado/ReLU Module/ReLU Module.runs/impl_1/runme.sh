...
HD_PWD='C:/Users/asus2/Desktop/FPGA/xilinx 2017.4 programs/ReLU Module/ReLU Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReLU_Activation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReLU_Activation.tcl -notrace
